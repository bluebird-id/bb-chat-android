package id.bluebird.chat.services;
...
class ContactsSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final String ACCKEY_SYNC_MARKER = "id.bluebird.chat.sync_marker_contacts";
    private static final String ACCKEY_QUERY_HASH = "id.bluebird.chat.sync_query_hash_contacts";
