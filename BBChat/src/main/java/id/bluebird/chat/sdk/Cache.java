...
public class Cache {
    ...
    public static synchronized Tinode getTinode() {
        if (sInstance.mTinode == null) {
            sInstance.mTinode = new Tinode("Bluebird Chat/" + BirdtalkApp.getAppVersion(), API_KEY,
            ...
            sInstance.mTinode.addListener(new Tinode.EventListener() {
                ...
                public void onDataMessage(MsgServerData data) {
                    ...
                    switch (callState) {
                        case STARTED:
                            CallManager.acceptIncomingCall(BirdtalkApp.getAppContext(),
                        ...
                        case DISCONNECTED:
                            ...
                            if (call != null && !call.isOutgoingCall()) {
                                ...
                                CallManager.dismissIncomingCall(BirdtalkApp.getAppContext(), data.topic, data.seq);
                            }
                            break;
                        default:
                            break;
                ...
                public void onInfoMessage(MsgServerInfo info) {
                    ...
                    if (MsgServerInfo.parseEvent(info.event) == MsgServerInfo.Event.HANG_UP ||
                        ...
                        CallManager.dismissIncomingCall(BirdtalkApp.getAppContext(), info.src, info.seq);
                    }
                }
            });

            // Keep in app to prevent garbage collection.
            BirdtalkApp.retainCache(sInstance);
        }
