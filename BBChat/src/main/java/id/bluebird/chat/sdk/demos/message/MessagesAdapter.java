...
import id.bluebird.chat.sdk.db.MessageDb;
import id.bluebird.chat.sdk.db.StoredMessage;
import id.bluebird.chat.sdk.format.CopyFormatter;
import id.bluebird.chat.sdk.format.FullFormatter;
import id.bluebird.chat.sdk.format.QuoteFormatter;
import id.bluebird.chat.sdk.format.StableLinkMovementMethod;
import id.bluebird.chat.sdk.format.ThumbnailTransformer;
...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.ViewHolder> {
    ...
    public MessagesAdapter(@NonNull MessageActivity context, @NonNull SwipeRefreshLayout refresher) {
        super();
